...
!\[image]\(../../image/image\_0\_b55c8bf9.png null)

而elasticsearch是elastic stack的核心，负责存储、搜索、分析数据。

!\[image]\(../../image/image\_1\_94442893.png null)
...
!\[image]\(../../image/image\_2\_1d5932d0.png null)
...
!\[image]\(../../image/image\_3\_79ad960c.png null)
...
!\[image]\(../../image/image\_4\_c1fc9522.png null)
...
!\[image]\(../../image/image\_5\_77c6612f.png null)
...
!\[image]\(../../image/image\_6\_1ec022f1.png null)
...
!\[image]\(../../image/image\_7\_8c5a7ed6.png null)
...
!\[image]\(../../image/image\_8\_8afa613f.png null)
...
!\[image]\(../../image/image\_9\_d53770c5.png null)
...
!\[image]\(../../image/image\_10\_c21eafac.png null)
...
!\[image]\(../../image/image\_11\_2103216f.png null)
...
!\[image]\(../../image/image\_12\_8a0ab6a6.png null)

此时，在浏览器输入地址访问：<http://192.168.194.131:5601>，即可看到结果如下图：

!\[image]\(../../image/image\_13\_f8499810.png null)

kibana左侧中提供了一个DevTools界面：

!\[image]\(../../image/image\_14\_d6171d46.png null)
...
!\[image]\(../../image/image\_15\_c64a07b2.png null)

**3）上传到es容器的插件数据卷中**

也就是`/var/lib/docker/volumes/es-plugins/_data `   ：

!\[image]\(../../image/image\_16\_2fa6d921.png null)
...
!\[image]\(../../image/image\_17\_98fd7882.png null)
...
!\[image]\(../../image/image\_18\_cc836059.png null)
...
!\[image]\(../../image/image\_19\_88eff9ff.png null)
...
!\[image]\(../../image/image\_20\_4d6019ff.png null)
...
!\[image]\(../../image/image\_21\_3b96bde5.png null)
...
!\[image]\(../../image/image\_22\_428fcce7.png null)
...
!\[image]\(../../image/image\_23\_64d15596.png null)
...
!\[image]\(../../image/image\_24\_3005e484.png null)
...
!\[image]\(../../image/image\_25\_35056765.png null)
...
!\[image]\(../../image/image\_26\_fed9fe4d.png null)

copy\_to说明：

!\[image]\(../../image/image\_27\_bc6434e3.png null)
...
!\[image]\(../../image/image\_28\_f3fd36b4.png null)
...
!\[image]\(../../image/image\_29\_6df3fb4d.png null)
...
!\[image]\(../../image/image\_30\_9b0ee01e.png null)
...
!\[image]\(../../image/image\_31\_e5a8fcbe.png null)
...
!\[image]\(../../image/image\_32\_28d51cca.png null)
...
!\[image]\(../../image/image\_33\_272a5d58.png null)
...
!\[image]\(../../image/image\_34\_a2098ee0.png null)
...
!\[image]\(../../image/image\_35\_8146dd9e.png null)
...
!\[image]\(../../image/image\_36\_f8be5f6b.png null)
...
!\[image]\(../../image/image\_37\_6fec80de.png null)

但是，当我搜索的内容不是词条，而是多个词语形成的短语时，反而搜索不到：

!\[image]\(../../image/image\_38\_48b58807.png null)
...
!\[image]\(../../image/image\_39\_f0893659.png null)
...
!\[image]\(../../image/image\_40\_3a1db7ed.png null)

附近的车：

!\[image]\(../../image/image\_41\_e00be772.png null)
...
!\[image]\(../../image/image\_42\_0dd54e91.gif null)
...
!\[image]\(../../image/image\_43\_d867984c.gif null)
...
!\[image]\(../../image/image\_44\_a759aaa2.png null)
...
!\[image]\(../../image/image\_45\_1014156b.png null)

在后来的5.1版本升级中，elasticsearch将算法改进为BM25算法，公式如下：

!\[image]\(../../image/image\_46\_875beff0.png null)

TF-IDF算法有一各缺陷，就是词条频率越高，文档得分也会越高，单个词条对文档影响较大。而BM25则会让单个词条的算分有一个上限，曲线更加平滑：

!\[image]\(../../image/image\_47\_65b97cd1.png null)
...
!\[image]\(../../image/image\_48\_6d7a782d.png null)
...
!\[image]\(../../image/image\_49\_efb1cf97.png null)
...
!\[image]\(../../image/image\_50\_ac617690.png null)

添加了算分函数后，如家得分就提升了：

!\[image]\(../../image/image\_51\_83322fce.png null)
...
!\[image]\(../../image/image\_52\_351288cc.png null)
...
!\[image]\(../../image/image\_53\_eedc002b.png null)
...
!\[image]\(../../image/image\_54\_19fd5c96.png null)

!\[image]\(../../image/image\_55\_5005035f.png null)
...
!\[image]\(../../image/image\_56\_5494b7ae.png null)
...
!\[image]\(../../image/image\_57\_bb2f2adc.png null)
...
!\[image]\(../../image/image\_58\_b8963404.png null)
...
!\[image]\(../../image/image\_59\_bf2bd298.png null)
...
!\[image]\(../../image/image\_60\_9d7a2028.png null)
...
!\[image]\(../../image/image\_61\_b98df186.png null)
...
!\[image]\(../../image/image\_62\_5559a594.png null)
...
!\[image]\(../../image/image\_63\_1550650c.png null)
...
!\[image]\(../../image/image\_64\_16d3a4d8.png null)

另一个是`QueryBuilders`，其中包含match、term、function\_score、bool等各种查询：

!\[image]\(../../image/image\_65\_53e5d71a.png null)

##### 3.1.2 解析响应结果

响应结果的解析：

!\[image]\(../../image/image\_66\_39b6cac2.png null)
...
!\[image]\(../../image/image\_67\_d38455cb.png null)

因此，Java代码上的差异主要是request.source().query()中的参数了。同样是利用QueryBuilders提供的方法：

!\[image]\(../../image/image\_68\_2dadebae.png null)
...
!\[image]\(../../image/image\_69\_6c8cef4f.png null)

##### 3.2.3 地理查询

DSL格式

!\[image]\(../../image/image\_70\_0a2d2f6a.png null)

在`cn.itcast.hotel.service.impl`的`HotelService`的`search`方法中，添加一个排序功能：

!\[image]\(../../image/image\_71\_e12127ce.png null)
...
!\[image]\(../../image/image\_72\_133e5410.png null)
...
!\[image]\(../../image/image\_73\_c64d1579.png null)

对应的JavaAPI如下：

!\[image]\(../../image/image\_74\_54eea54e.png null)
...
!\[image]\(../../image/image\_75\_d1851d7d.png null)
...
!\[image]\(../../image/image\_76\_4874f0f9.png null)
...
!\[image]\(../../image/image\_77\_1df99b8b.png null)
...
!\[image]\(../../image/image\_78\_246efc22.png null)

聚合的结果也与查询结果不同，API也比较特殊。不过同样是JSON逐层解析：

!\[image]\(../../image/image\_79\_17becde5.png null)
...
!\[image]\(../../image/image\_80\_6f47cc44.png null)
...
!\[image]\(../../image/image\_81\_535b169b.png null)

课前资料中也提供了拼音分词器的安装包：

!\[image]\(../../image/image\_82\_94e95086.png null)
...
!\[image]\(../../image/image\_83\_4f9c362a.png null)
...
!\[image]\(../../image/image\_84\_b63c275f.png null)
...
!\[image]\(../../image/image\_85\_e911b6b3.png null)
...
!\[image]\(../../image/image\_86\_b43f2abe.png null)

**解析结果代码如下：**

!\[image]\(../../image/image\_87\_08a8f43d.png null)
...
!\[image]\(../../image/image\_88\_fe43cdf2.png null)
...
!\[image]\(../../image/image\_89\_6dc77d9a.png null)
...
!\[image]\(../../image/image\_90\_37c51920.png null)
...
!\[image]\(../../image/image\_91\_86e50680.png null)
...
!\[image]\(../../image/image\_92\_8341eba9.png null)
...
!\[image]\(../../image/image\_93\_6b89ea0c.png null)
...
!\[image]\(../../image/image\_94\_05fdcff5.png null)
...
!\[image]\(../../image/image\_95\_62590ee9.png null)

解压即可使用，非常方便。

解压好的目录如下：

!\[image]\(../../image/image\_96\_fb3d6696.png null)

进入对应的bin目录：

!\[image]\(../../image/image\_97\_9a01c657.png null)

双击其中的cerebro.bat文件即可启动服务。

!\[image]\(../../image/image\_98\_014b808b.png null)

访问<http://localhost:9000> 即可进入管理界面：

!\[image]\(../../image/image\_99\_9effb3a5.png null)

输入你的elasticsearch的任意节点的地址和端口，点击connect即可：

!\[image]\(../../image/image\_100\_c346e345.png null)
...
!\[image]\(../../image/image\_101\_effc5aca.png null)

填写索引库信息：

!\[image]\(../../image/image\_102\_50630154.png null)

点击右下角的create按钮：

!\[image]\(../../image/image\_103\_f20649b6.png null)

##### 查看分片效果

回到首页，即可查看索引库分片效果：

!\[image]\(../../image/image\_104\_146fd918.png null)
...
!\[image]\(../../image/image\_105\_5a737ec6.png null)
...
!\[image]\(../../image/image\_106\_d1e28b24.png null)
...
!\[image]\(../../image/image\_107\_a5acd4ac.png null)

此时，node2和node3认为node1宕机，就会重新选主：

!\[image]\(../../image/image\_108\_894e89ce.png null)

当node3当选后，集群继续对外提供服务，node2和node3自成集群，node1自成集群，两个集群数据不同步，出现数据差异。

当网络恢复后，因为集群中有两个master节点，集群状态的不一致，出现脑裂的情况：

!\[image]\(../../image/image\_109\_265cf391.png null)
...
!\[image]\(../../image/image\_110\_b2cf8b3e.png null)

!\[image]\(../../image/image\_111\_ce7e14ac.png null)

!\[image]\(../../image/image\_112\_861908b0.png null)

测试可以看到，三条数据分别在不同分片：

!\[image]\(../../image/image\_113\_372c484e.png null)

结果：

!\[image]\(../../image/image\_114\_78ada2b7.png null)

#### 3.2.分片存储原理

elasticsearch会通过hash算法来计算文档应该存储到哪个分片：

!\[image]\(../../image/image\_115\_35e8dfdb.png null)
...
!\[image]\(../../image/image\_116\_e6517c09.png null)
...
!\[image]\(../../image/image\_117\_124ab2f2.png null)
...
!\[image]\(../../image/image\_118\_c1c40b6b.png null)

现在，node1是主节点，其它两个节点是从节点。

2）突然，node1发生了故障：

!\[image]\(../../image/image\_119\_8dfa28ac.png null)

宕机后的第一件事，需要重新选主，例如选中了node2：

!\[image]\(../../image/image\_120\_009809b9.png null)

node2成为主节点后，会检测集群监控状态，发现：shard-1、shard-0没有副本节点。因此需要将node1上的数据迁移到node2、node3：

!\[image]\(../../image/image\_121\_61185208.png null)
