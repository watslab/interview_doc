...
![image](image/image_0_b55c8bf9.png)

而elasticsearch是elastic stack的核心，负责存储、搜索、分析数据。

![image](image/image_1_94442893.png)
...
![image](image/image_2_1d5932d0.png)
...
![image](image/image_3_79ad960c.png)
...
![image](image/image_4_c1fc9522.png)
...
![image](image/image_5_77c6612f.png)
...
![image](image/image_6_1ec022f1.png)
...
![image](image/image_7_8c5a7ed6.png)
...
![image](image/image_8_8afa613f.png)
...
![image](image/image_9_d53770c5.png)
...
![image](image/image_10_c21eafac.png)
...
![image](image/image_11_2103216f.png)
...
![image](image/image_12_8a0ab6a6.png)

此时，在浏览器输入地址访问：<http://192.168.194.131:5601>，即可看到结果如下图：

![image](image/image_13_f8499810.png)

kibana左侧中提供了一个DevTools界面：

![image](image/image_14_d6171d46.png)
...
![image](image/image_15_c64a07b2.png)

**3）上传到es容器的插件数据卷中**

也就是`/var/lib/docker/volumes/es-plugins/_data `：

![image](image/image_16_2fa6d921.png)
...
![image](image/image_17_98fd7882.png)
...
![image](image/image_18_cc836059.png)
...
![image](image/image_19_88eff9ff.png)
...
![image](image/image_20_4d6019ff.png)
...
![image](image/image_21_3b96bde5.png)
...
![image](image/image_22_428fcce7.png)
...
![image](image/image_23_64d15596.png)
...
![image](image/image_24_3005e484.png)
...
![image](image/image_25_35056765.png)
...
![image](image/image_26_fed9fe4d.png)

copy_to说明：

![image](image/image_27_bc6434e3.png)
...
![image](image/image_28_f3fd36b4.png)
...
![image](image/image_29_6df3fb4d.png)
...
![image](image/image_30_9b0ee01e.png)
...
![image](image/image_31_e5a8fcbe.png)
...
![image](image/image_32_28d51cca.png)
...
![image](image/image_33_272a5d58.png)
...
![image](image/image_34_a2098ee0.png)
...
![image](image/image_35_8146dd9e.png)
...
![image](image/image_36_f8be5f6b.png)
...
![image](image/image_37_6fec80de.png)

但是，当我搜索的内容不是词条，而是多个词语形成的短语时，反而搜索不到：

![image](image/image_38_48b58807.png)
...
![image](image/image_39_f0893659.png)
...
![image](image/image_40_3a1db7ed.png)

附近的车：

![image](image/image_41_e00be772.png)
...
![image](image/image_42_0dd54e91.gif)
...
![image](image/image_43_d867984c.gif)
...
![image](image/image_44_a759aaa2.png)
...
![image](image/image_45_1014156b.png)

在后来的5.1版本升级中，elasticsearch将算法改进为BM25算法，公式如下：

![image](image/image_46_875beff0.png)

TF-IDF算法有一各缺陷，就是词条频率越高，文档得分也会越高，单个词条对文档影响较大。而BM25则会让单个词条的算分有一个上限，曲线更加平滑：

![image](image/image_47_65b97cd1.png)
...
![image](image/image_48_6d7a782d.png)
...
![image](image/image_49_efb1cf97.png)
...
![image](image/image_50_ac617690.png)

添加了算分函数后，如家得分就提升了：

![image](image/image_51_83322fce.png)
...
![image](image/image_52_351288cc.png)
...
![image](image/image_53_eedc002b.png)
...
![image](image/image_54_19fd5c96.png)

![image](image/image_55_5005035f.png)
...
![image](image/image_56_5494b7ae.png)
...
![image](image/image_57_bb2f2adc.png)
...
![image](image/image_58_b8963404.png)
...
![image](image/image_59_bf2bd298.png)
...
![image](image/image_60_9d7a2028.png)
...
![image](image/image_61_b98df186.png)
...
![image](image/image_62_5559a594.png)
...
![image](image/image_63_1550650c.png)
...
![image](image/image_64_16d3a4d8.png)

另一个是`QueryBuilders`，其中包含match、term、function_score、bool等各种查询：

![image](image/image_65_53e5d71a.png)

##### 3.1.2 解析响应结果

响应结果的解析：

![image](image/image_66_39b6cac2.png)
...
![image](image/image_67_d38455cb.png)

因此，Java代码上的差异主要是request.source().query()中的参数了。同样是利用QueryBuilders提供的方法：

![image](image/image_68_2dadebae.png)
...
![image](image/image_69_6c8cef4f.png)

##### 3.2.3 地理查询

DSL格式

![image](image/image_70_0a2d2f6a.png)

在`cn.itcast.hotel.service.impl`的`HotelService`的`search`方法中，添加一个排序功能：

![image](image/image_71_e12127ce.png)
...
![image](image/image_72_133e5410.png)
...
![image](image/image_73_c64d1579.png)

对应的JavaAPI如下：

![image](image/image_74_54eea54e.png)
...
![image](image/image_75_d1851d7d.png)
...
![image](image/image_76_4874f0f9.png)
...
![image](image/image_77_1df99b8b.png)
...
![image](image/image_78_246efc22.png)

聚合的结果也与查询结果不同，API也比较特殊。不过同样是JSON逐层解析：

![image](image/image_79_17becde5.png)
...
![image](image/image_80_6f47cc44.png)
...
![image](image/image_81_535b169b.png)

课前资料中也提供了拼音分词器的安装包：

![image](image/image_82_94e95086.png)
...
![image](image/image_83_4f9c362a.png)
...
![image](image/image_84_b63c275f.png)
...
![image](image/image_85_e911b6b3.png)
...
![image](image/image_86_b43f2abe.png)

**解析结果代码如下：**

![image](image/image_87_08a8f43d.png)
...
![image](image/image_88_fe43cdf2.png)
...
![image](image/image_89_6dc77d9a.png)
...
![image](image/image_90_37c51920.png)
...
![image](image/image_91_86e50680.png)
...
![image](image/image_92_8341eba9.png)
...
![image](image/image_93_6b89ea0c.png)
...
![image](image/image_94_05fdcff5.png)
...
![image](image/image_95_62590ee9.png)

解压即可使用，非常方便。

解压好的目录如下：

![image](image/image_96_fb3d6696.png)

进入对应的bin目录：

![image](image/image_97_9a01c657.png)

双击其中的cerebro.bat文件即可启动服务。

![image](image/image_98_014b808b.png)

访问http://localhost:9000 即可进入管理界面：

![image](image/image_99_9effb3a5.png)

输入你的elasticsearch的任意节点的地址和端口，点击connect即可：

![image](image/image_100_c346e345.png)
...
![image](image/image_101_effc5aca.png)

填写索引库信息：

![image](image/image_102_50630154.png)

点击右下角的create按钮：

![image](image/image_103_f20649b6.png)

##### 查看分片效果

回到首页，即可查看索引库分片效果：

![image](image/image_104_146fd918.png)
...
![image](image/image_105_5a737ec6.png)
...
![image](image/image_106_d1e28b24.png)
...
![image](image/image_107_a5acd4ac.png)

此时，node2和node3认为node1宕机，就会重新选主：

![image](image/image_108_894e89ce.png)

当node3当选后，集群继续对外提供服务，node2和node3自成集群，node1自成集群，两个集群数据不同步，出现数据差异。

当网络恢复后，因为集群中有两个master节点，集群状态的不一致，出现脑裂的情况：

![image](image/image_109_265cf391.png)
...
![image](image/image_110_b2cf8b3e.png)

![image](image/image_111_ce7e14ac.png)

![image](image/image_112_861908b0.png)

测试可以看到，三条数据分别在不同分片：

![image](image/image_113_372c484e.png)

结果：

![image](image/image_114_78ada2b7.png)

#### 3.2.分片存储原理

elasticsearch会通过hash算法来计算文档应该存储到哪个分片：

![image](image/image_115_35e8dfdb.png)
...
![image](image/image_116_e6517c09.png)
...
![image](image/image_117_124ab2f2.png)
...
![image](image/image_118_c1c40b6b.png)

现在，node1是主节点，其它两个节点是从节点。

2）突然，node1发生了故障：

![image](image/image_119_8dfa28ac.png)

宕机后的第一件事，需要重新选主，例如选中了node2：

![image](image/image_120_009809b9.png)

node2成为主节点后，会检测集群监控状态，发现：shard-1、shard-0没有副本节点。因此需要将node1上的数据迁移到node2、node3：

![image](image/image_121_61185208.png)
