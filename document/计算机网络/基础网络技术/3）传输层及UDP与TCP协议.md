...
- **拥塞避免为何线性增长**：达到门限后，每个 ACK 的增量从 1 MSS 缩小为约 1/cwnd MSS（实现为 cwnd += SMSS×SMSS/cwnd），一轮 cwnd 个 ACK 累计仅使 cwnd 增加约 1 MSS——逼近未知容量时放缓脚步，即使引发丢包，损失也被控制在最小；
